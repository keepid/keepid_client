...
function onFormSubmit(e) {
  try {
    ...
    const result = triggerWindmillJob(message, clientPhone, fromPhone, accountSid, authToken, windmillToken);
 ...
 */
function triggerWindmillJob(message, toPhone, fromPhone, accountSid, authToken, windmillToken) {
  const endpoint = 'https://app.windmill.dev/api/w/keepid/jobs/run/f/f/keepid/keep_id_notification_flow';
