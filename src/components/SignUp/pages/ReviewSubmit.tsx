...
export const ReviewSubmitV2 = ({ onSubmit: onSubmitProp }: PropsV2) => {
  const {
      ...
      <form>
        <div className="d-flex justify-content-center pt-5">
          <div className="col-md-10">
            ...
            <table className="table mb-4">
              ...
              <tr>
                ...
                <th
                  scope="col"
                  onClick={() =>
                    signUpStageStateContext.moveToSignupStage && signUpStageStateContext.moveToSignupStage(SignupStage.ACCOUNT_INFORMATION)
                  }
                >
                  <a href="#">Edit</a>
                </th>
            ...
            {signUpStageStateContext?.stages?.includes(
              ...
              <table className="table mb-4">
                ...
                <tr>
                  ...
                  <th
                    scope="col"
                    onClick={() =>
                      signUpStageStateContext.moveToSignupStage && signUpStageStateContext.moveToSignupStage(SignupStage.ORGANIZATION_INFORMATION)
                    }
                  >
                    <a href="#">Edit</a>
                  </th>
            ...
            <div className="d-flex">
              <button
                type="button"
                className="btn btn-outline-primary mt-5"
                onClick={signUpStageStateContext.moveToPreviousSignupStage}
              >
                Previous Step
              </button>
              <button
