...
export class PersonalInformation extends Component<Props, State, {}> {
  ...
  validateFirstname = async (): Promise<void> => {
    ...
    if (isValidFirstName(firstname)) {
      await new Promise((resolve) =>
        this.setState({ firstnameValidator: 'true' }, resolve));
    } else {
      await new Promise((resolve) =>
        this.setState({ firstnameValidator: 'false' }, resolve));
    }
  };
  ...
  validateLastname = async (): Promise<void> => {
    ...
    if (isValidLastName(lastname)) {
      await new Promise((resolve) =>
        this.setState({ lastnameValidator: 'true' }, resolve));
    } else {
      await new Promise((resolve) =>
        this.setState({ lastnameValidator: 'false' }, resolve));
    }
  };
  ...
  validateBirthdate = async (): Promise<void> => {
    ...
    if (isValidBirthDate(birthDateStringConverter(birthDate))) {
      await new Promise((resolve) =>
        this.setState({ birthDateValidator: 'true' }, resolve));
    } else {
      await new Promise((resolve) =>
        this.setState({ birthDateValidator: 'false' }, resolve));
    }
  };
  ...
  validateAddress = async (): Promise<void> => {
    ...
    if (isValidAddress(address)) {
      await new Promise((resolve) =>
        this.setState({ addressValidator: 'true' }, resolve));
    } else {
      await new Promise((resolve) =>
        this.setState({ addressValidator: 'false' }, resolve));
    }
  };
  ...
  validateCity = async (): Promise<void> => {
    ...
    if (isValidCity(city)) {
      await new Promise((resolve) =>
        this.setState({ cityValidator: 'true' }, resolve));
    } else {
      await new Promise((resolve) =>
        this.setState({ cityValidator: 'false' }, resolve));
    }
  };
  ...
  validateState = async (): Promise<void> => {
    ...
    if (isValidUSState(state)) {
      await new Promise((resolve) =>
        this.setState({ stateValidator: 'true' }, resolve));
    } else {
      await new Promise((resolve) =>
        this.setState({ stateValidator: 'false' }, resolve));
    }
  };
  ...
  validateZipcode = async (): Promise<void> => {
    ...
    if (isValidZipCode(zipcode)) {
      await new Promise((resolve) =>
        this.setState({ zipcodeValidator: 'true' }, resolve));
    } else {
      await new Promise((resolve) =>
        this.setState({ zipcodeValidator: 'false' }, resolve));
    }
  };
  ...
  validatePhonenumber = async (): Promise<void> => {
    ...
    if (isValidPhoneNumber(phonenumber)) {
      await new Promise((resolve) =>
        this.setState({ phonenumberValidator: 'true' }, resolve));
    } else {
      await new Promise((resolve) =>
        this.setState({ phonenumberValidator: 'false' }, resolve));
    }
  };
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>Sign Up- Personal Info</title>
        ...
        <div className="d-flex justify-content-center pt-5">
          <div className="col-md-10">
            <div className="text-center pb-4 mb-2">
              <h2>
                <b>Next, add in some contact information.</b>
              </h2>
            </div>
