  ...
  render() {
    return (
      <div className="container">
        ...
        <div className="row">
          <a href="https://docs.google.com/document/d/1a84MRuc958CCsapjwbGlJcWYpyGWG_uvRpC9fROsFWg/edit?usp=sharing" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-primary btn-lg mr-3">Business Analyst</button></a>
          <a href="https://docs.google.com/document/d/1rV_RGhXzO1cZ04QJOgu2zaK7lpR1dp_9EV8fYi_5q4g/edit?usp=sharing" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-primary btn-lg mr-3">Nonprofit/Donor Ambassador</button></a>
        </div>
      </div>
    );
  }
