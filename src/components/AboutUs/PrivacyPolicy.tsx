    ...
    <div className="container">
      ...
      <div className="jumbotron-fluid mt-5">
        ...
        <p className="lead-medium pt-3">
          ...
          Keep.id will be storing them on the secure cloud, able to be accessed
          with the Internet and only by you and those with permitted access.
          With your identification documents stored on Keep.id, you’ll be able
          to gain access to government and aid services and have a reliable
          location for storing your identification. See
      ...
      <div className="jumbotron-fluid mt-5">
        ...
        <p className="lead-medium pt-3">
          ...
          birthdate, etc. This is completely voluntary and only according to the
          forms of identification or government/agency applications you’ll be
          filling out. On our end, we collect your IP address and page visits to
          ensure you’re a real person (i.e. not a bot) and record login
          attempts, which help us keep the product secure.
        ...
        <p className="lead-medium pt-2">
          We obtain the IP address from the HTTP request headers; the voluntary
          release information is collected through the forms and uploads. Your
          information is stored by secure cloud providers; as of now, we will
          store it indefinitely or until further notice.
        </p>
      </div>
      <div className="jumbotron-fluid mt-5">
        ...
        <ul>
          <li className="lead-medium pt-2">
            ...
            organizations, and encrypted documents. This tier is only accessible
            to employees of Team Keep. We protect this tier with rigorous
            security measures including access control and two-factor
            authentication.
          </li>
          <li className="lead-medium pt-2">
          ...
          <li className="lead-medium pt-2">
            ...
            all of their own personal information and cannot see the information
            of other users. The secure storage of this information as well as
            its secure transmission over the Internet to nonprofits and other
            partners is the purpose of Keep.id.
          </li>
          <li className="lead-medium pt-2">
            ...
            tier to Keep.id’s server. We share this information with Google as a
            third-party service in the form of ReCaptcha, which helps to prevent
            bots.
          </li>
        </ul>
      </div>
      <div className="jumbotron-fluid mt-5">
        ...
        <p className="lead-medium pt-3">
          ...
          with Cloudflare serve as our DNS and DDoS protection. With server
          logging we keep track of activity and audit the application. In
          addition, we have installed automatic logoff so that if you leave the
          application open and unattended for some time, you will be
      ...
      <div className="jumbotron-fluid mt-5">
        ...
        <p className="lead-medium pt-2">
          You are also able to delete documents after uploading them to Keep.id
          at your discretion.
        </p>
      </div>
      <div className="jumbotron-fluid mt-5">
        ...
        <p className="lead-medium pt-3">
          ...
          websites. By using your IP address and ReCaptcha, we can prevent bots
          from disrupting Keep.id.
        </p>
        <p className="lead-medium pt-2">
        ...
        <p className="lead-medium pt-2">EIN: Employee Identification Number.</p>
        <p className="lead-medium pt-2">
          ...
          website. HTTPS (Hypertext Transfer Protocol Secure) is an extension of
          HTTP that adds protection across the channel of communication.
        </p>
        <p className="lead-medium pt-2">
          IP Address: Internet Protocol Address. An IP address is given to any
          piece of hardware that accesses the Internet. These addresses contain
          geographic information in many cases, and therefore can be used to
          track users.
        </p>
        <p className="lead-medium pt-2">
          Two-Factor Authentication: You have to provide two distinct pieces of
          information in order to prove your identity and gain access to an
          application. They include something only you know, something only you
          have, or inherent factors (fingerprint, voice recognition, etc.).
        </p>
      </div>
      <div className="jumbotron-fluid mt-5">
        ...
        <p className="lead-medium pt-3">
          ...
          policy does not apply to services that have separate privacy policies
      ...
      <div className="jumbotron-fluid mt-5">
        ...
        <p className="lead-medium pt-3">
          Please reach out to us with any questions you have about your security
          or identification. As an organization that specializes in this very
          subject, we take your concern seriously.
        </p>
        <p className="lead-medium pt-2">
