              ...
              <div className="tw-mt-8">
                ...
                <div>
                  ...
                  <div className="tw-text-sm tw-text-gray-600 tw-mt-1">
                    Choose a supported form or create an application from a PDF.
                  </div>
                  <div className="tw-mt-4 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-3">
                    {availableApplications.map((application) => (
                      <Link
                        ...
                        className="tw-flex tw-min-h-[7rem] tw-items-center tw-gap-4 tw-rounded-lg tw-border tw-border-gray-200 tw-bg-white tw-p-4 tw-text-gray-900 tw-no-underline tw-shadow-sm tw-transition-all hover:tw-border-blue-300 hover:tw-bg-blue-50 hover:tw-text-gray-900 hover:tw-shadow-md"
                      >
                        <span className="tw-flex tw-h-12 tw-w-12 tw-shrink-0 tw-items-center tw-justify-center tw-rounded-lg tw-border tw-border-gray-200 tw-bg-gray-50 tw-text-gray-600">
                          <i className="fas fa-file-alt" aria-hidden />
                        </span>
                        <span className="tw-min-w-0 tw-flex-1">
                          <span className="tw-block tw-font-semibold tw-leading-snug">
                          ...
                          <span className="tw-mt-1 tw-block tw-text-sm tw-text-gray-600">
                            Supported Keep.id form
                          </span>
                        </span>
                        <i className="fas fa-chevron-right tw-text-gray-400 tw-text-xs" aria-hidden />
                      </Link>
                    ))}
                    {availableApplications.length === 0 && (
                      <div className="tw-flex tw-min-h-[7rem] tw-items-center tw-rounded-lg tw-border tw-border-gray-200 tw-bg-white tw-p-4 tw-text-sm tw-text-gray-500 tw-shadow-sm">
                        No supported forms are available.
                      </div>
                    )}
                    <Link
                      to={{
                        pathname: '/applications/create-from-document',
                        state: {
                          clientUsername: clientUsername || '',
                          clientName: clientName || '',
                        },
                    ...
                    >
                      ...
                      <span className="tw-min-w-0 tw-flex-1">
                        ...
                        <span className="tw-mt-1 tw-block tw-text-sm tw-text-gray-600">
                          Upload a PDF or use an organization document.
                        </span>
                      </span>
                      <i className="fas fa-chevron-right tw-text-gray-400 tw-text-xs" aria-hidden />
                    </Link>
