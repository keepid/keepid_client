    ...
    return (          
      <div className="container">
        <div className="jumbotron-fluid mt-5">
          ...
          The Mission of Team Keep.id is to <b>prioritize collaboration</b> with our respective stakeholders, 
          be <b>purpose-led</b> in our technical and non-technical work, and <b>practice empathy</b> in the ways we interact 
        ...
        <div className="jumbotron-fluid mt-5">
          ...
          <p className="lead pt-3">
            Our three pillars are <b>collaboration</b>, <b>purpose</b>, and <b>empathy</b>.
            <ul>
              <li className="pt-2">
                <b>Collaboration:</b> We understand that without working closely with existing organizations and human support networks, 
                we cannot generate any substantial impact with great technology alone.
              </li>
              <li className="pt-1">
                <b>Purpose:</b> We understand the particular position and information we have on a disadvantaged population. We aim to create sustainable, 
                impact-driven features that have beneficial implications on those who entrust us with their data. 
              </li>
              <li className="pt-1">
                <b>Empathy:</b> Without practicing empathy, we begin to abandon our mission and will succumb to the capitalist forces of systemic greed and exploitation. 
        ...
        <div className="jumbotron-fluid mt-5">
          ...
          <p className="lead pt-3">
            ...
            <ul>
              <li className="pt-2">
                <b>HIPAA Compliance</b> is a major engineering milestone that signals the technical integrity of our product.
              </li>
              <li className="pt-1">
                <b>Securing Funding</b> namely through competitions. This will ensure the financial sustainability of our venture, allowing for 
                long term support, the addition of new features, and technical scalability. 
              </li>
              <li className="pt-1">
                <b>Achieve Local Buy-in</b> from local partner organizations in whatever regional hub we are focusing on. 
