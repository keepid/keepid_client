...
public class UploadTests {
    ...
    void changePass() throws UnsupportedEncodingException, MessagingException {
        EmailUtil.sendEmail("smtp.gmail.com", "587", "keepidtest@gmail.com", "Keep ID", "t3stPasw", "keepidtest@gmail.com", "Test", "Test");
        ChangePassword.change("Steffen12-Cornwell", "test", "test2", database);
    }
    @Test
    void randGen(){
        String newPass = RandomStringUtils.
                random(8, 30, 122, true, true, null, new SecureRandom());
